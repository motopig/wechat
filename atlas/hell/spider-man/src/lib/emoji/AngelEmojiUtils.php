...
class AngelEmojiUtils
{
	...
	function __construct(){
	 ...
	 $this->semoji = [
    	...
    	$this->semoji['emoji_maps']['html_to_unified'] = array_flip($this->semoji['emoji_maps']['unified_to_html']);
	...
	function emoji_convert($text, $map){
		...
		return str_replace(array_keys($this->semoji['emoji_maps'][$map]), $this->semoji['emoji_maps'][$map], $text);
	}

	function emoji_get_name($unified_cp){

		return $this->semoji['emoji_maps']['names'][$unified_cp] ? $this->semoji['emoji_maps']['names'][$unified_cp] : '?';
	}
}