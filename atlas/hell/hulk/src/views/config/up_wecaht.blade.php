                ...
                <div class="panel-body">
                    <div class="tab-content">
                        <div class='tab-pane fade active in' id="tab-auto">
                            ...
                            @if (isset($open) && $open['disabled'] == 'true')
                            ...
                            <a href="javascript:void(0);" class="btn btn-lg btn-info">
                                <i class="fa fa-wechat" style="color:#fff;font-size:20px;"></i>&nbsp;微信公众号已授权！
                            @endif
                            </a>
                        ...
                        <!-- <div class='tab-pane fade' id="tab-config">
                            ...
                            <div class="hand-setting">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">
                                        <input type="text" readonly name="appid" class="form-control text-black" 
                                        value="@if (isset($wechat)) {{$wechat['appid']}} @endif">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">
                                        <input type="text" readonly name="appsecret" class="form-control text-black" 
                                        value="@if (isset($wechat)) {{$wechat['appsecret']}} @endif">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        value="@if (isset($wechat)) {{$wechat['encodingAesKey']}} @endif">
